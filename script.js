...
const DATA_URL = "https://docs.google.com/spreadsheets/d/e/2PACX-1vTOdQ33IqaCOXKXhjzPMB9e35fajKZfN7n6AOn5Citte64Fu9KXz4hWh1GK52848y-1YIm7vnp9tArr/pub?gid=1745453083&single=true&output=csv"; 
// IMPORTANT: Replace this with YOUR DEPLOYED GOOGLE APPS SCRIPT WEB APP URL
const WEB_APP_URL = "https://script.google.com/macros/s/AKfycbyaO5wpdeXC5wz85iz84CsM-CtDpptlaxrXkEh30ZYcGd2kvP7N1K0G6xpLWm9O12mJ/exec"; // <-- PASTE YOUR NEWLY DEPLOYED WEB APP URL HERE
...
function filterDataByMonth(data, selectedMonthValue) {
    ...
    return data.filter(entry => {
        ...
        const entryDate = parseDateWithTime(timestampValue); // CHANGED: Use the new parsing function
